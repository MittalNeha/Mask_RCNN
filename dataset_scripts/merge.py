...
if __name__ == '__main__':
    ...
    # Merge all the .json files in the working directory
    ...
    print(annot_files)
    temp_out = "annot_merged.json"

    f1 = annot_files.pop()
    for f in annot_files:
        combine(f1, f, temp_out)
        f1 = temp_out
    # combine(sys.argv[1],sys.argv[2],sys.argv[3])
    print("\n\nSuccessfully merged the two files into {}".format(temp_out))
